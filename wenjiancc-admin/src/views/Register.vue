<template>
  <div class="container">
    ...
    <div style="display: flex; justify-content: center; width: 100%">
      <div style="width: 350px; padding: 50px 30px; box-shadow: 0 0 10px rgba(0,0,0,.2); background-color: #fff; border-radius: 5px;">
        <div style="text-align: center; font-size: 24px; font-weight: bold; margin-bottom: 30px; color: #333">注 册</div>
