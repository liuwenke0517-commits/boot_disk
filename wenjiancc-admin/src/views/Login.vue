<template>
  <div class="container">
    <div style="height: 60px; position: fixed; top: 0; display: flex; align-items: center; padding-left: 20px">
      ...
      <span style="color: #fff; font-size: 24px; font-weight: bold; margin-left: 5px">私有网盘系统</span>
    </div>
    ...
    <div style="flex: 1; display: flex; justify-content: center">
      <div style="width: 350px; position: relative; padding: 50px 30px; box-shadow: 0 0 10px rgba(0,0,0,.2); background-color: white; border-radius: 5px;">
        <div style="position: absolute; background-color: white; top: 100px; z-index: 999"
          ...
          <slide-verify :l="42"
                        ...
                        slider-text="向右滑动"
                        @success="onSuccess"
                        ref="slideVerifyRef"></slide-verify>
        </div>
        <div style="text-align: center; font-size: 24px; font-weight: bold; margin-bottom: 30px; color: #333">登 录</div>
        <el-form :model="form"
                 :rules="rules"
                 ref="formRef">
          ...
          <el-form-item>
            <el-button size="medium"
                       style="width: 100%; background-color: #2a60c9; border-color: #2a60c9; color: white"
